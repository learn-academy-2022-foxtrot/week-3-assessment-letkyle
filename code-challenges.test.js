...
// PSEUDOCODE:
    ...
    // create a test starting with describe and the function name "fib"
...
// b) Create the function that makes the test pass.
    ...
    const leastToGreatest = (object) => {  
        let filteredArr = object.filter(value => typeof value === "number")
        object.sort((a,b) => a-b)
        return object
    }
...
// a) Create a test with expect statements for each of the variables provided.
    ...
    //Pseudo code describe a function named accSum
